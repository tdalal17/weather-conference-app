...
let Conference = (() => {
    ...
    var Conference = _classThis = class {
        constructor() {
            ...
            this.author = (__runInitializers(this, _endDate_extraInitializers), __runInitializers(this, _author_initializers, void 0));
            this.topic = (__runInitializers(this, _author_extraInitializers), __runInitializers(this, _topic_initializers, void 0));
            __runInitializers(this, _topic_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "Conference");
    (() => {
        ...
        _author_decorators = [(0, typeorm_1.ManyToOne)(() => Author_1.Author), (0, typeorm_1.JoinColumn)()];
        _topic_decorators = [(0, typeorm_1.ManyToOne)(() => Topic_1.Topic), (0, typeorm_1.JoinColumn)()];
        ...
        Conference = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Conference = _classThis;
})();
